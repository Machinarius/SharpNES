...
namespace SharpNES.Core.CPU.Internal {
  public class MOS6502InstructionLookupTable : IInstructionLookupTable {
    ...
    private void FillInstructionsList() {
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 8, true));
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 3, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5, true));
      _instructions.Add(new CpuInstruction("PHP", _executor.PushProcessorStatus, _addressingModes.Implicit, 3, true));
      _instructions.Add(new CpuInstruction("ORA", _executor.OrWithAccumulator, _addressingModes.Immediate, 2));
      _instructions.Add(new CpuInstruction("ASL", _executor.ArithmeticShiftLeft, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 4, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 6, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 6, true));
      _instructions.Add(new CpuInstruction("CLC", _executor.ClearCarry, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("ORA", _executor.OrWithAccumulator, _addressingModes.AbsoluteY, 4));
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 7, true));
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 4, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5, true));
      _instructions.Add(new CpuInstruction("PLP", _executor.PullProcessorStatus, _addressingModes.Implicit, 4, true));
      _instructions.Add(new CpuInstruction("AND", _executor.AndWithAccumulator, _addressingModes.Immediate, 2));
      _instructions.Add(new CpuInstruction("ROL", _executor.RotateLeft, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 2, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 6, true));
      _instructions.Add(new CpuInstruction("SEC", _executor.SetCarry, _addressingModes.Implicit, 2, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 7, true));
      _instructions.Add(new CpuInstruction("RTI", _executor.ReturnFromInterrupt, _addressingModes.Implicit, 6, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5, true));
      _instructions.Add(new CpuInstruction("PHA", _executor.PushAccumulator, _addressingModes.Implicit, 3, true));
      _instructions.Add(new CpuInstruction("EOR", _executor.ExclusiveOr, _addressingModes.Immediate, 2));
      _instructions.Add(new CpuInstruction("LSR", _executor.LogicalShiftRight, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 2, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 6, true));
      _instructions.Add(new CpuInstruction("CLI", _executor.ClearInterruptDisable, _addressingModes.Implicit, 2, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 7, true));
      _instructions.Add(new CpuInstruction("RTS", _executor.ReturnFromSubroutine, _addressingModes.Implicit, 6, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5, true));
      _instructions.Add(new CpuInstruction("PLA", _executor.PullAccumulator, _addressingModes.Implicit, 4, true));
      _instructions.Add(new CpuInstruction("ADC", _executor.AddWithCarry, _addressingModes.Immediate, 2));
      _instructions.Add(new CpuInstruction("ROR", _executor.RotateRight, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 2, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 6, true));
      _instructions.Add(new CpuInstruction("SEI", _executor.SetInterruptDisable, _addressingModes.Implicit, 2, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 3, true));
      _instructions.Add(new CpuInstruction("DEY", _executor.DecrementY, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("TXA", _executor.TransferXToAccumulator, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 2, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 4, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 4, true));
      _instructions.Add(new CpuInstruction("TYA", _executor.TransferYToAccumulator, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("STA", _executor.StoreAccumulator, _addressingModes.AbsoluteY, 5));
      _instructions.Add(new CpuInstruction("TXS", _executor.TransferXToStackPointer, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5, true));
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 5, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 3, true));
      _instructions.Add(new CpuInstruction("TAY", _executor.TransferAccumulatorToY, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("LDA", _executor.LoadAccumulator, _addressingModes.Immediate, 2));
      _instructions.Add(new CpuInstruction("TAX", _executor.TransferAccumulatorToX, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 2, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 4, true));
      _instructions.Add(new CpuInstruction("CLV", _executor.ClearOverflow, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("LDA", _executor.LoadAccumulator, _addressingModes.AbsoluteY, 4));
      _instructions.Add(new CpuInstruction("TSX", _executor.TransferStackPointerToX, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 4, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5, true));
      _instructions.Add(new CpuInstruction("INY", _executor.IncrementY, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("CMP", _executor.CompareWithAccumulator, _addressingModes.Immediate, 2));
      _instructions.Add(new CpuInstruction("DEX", _executor.DecrementX, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 2, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 6, true));
      _instructions.Add(new CpuInstruction("CLD", _executor.ClearDecimal, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("CMP", _executor.CompareWithAccumulator, _addressingModes.AbsoluteY, 4));
      _instructions.Add(new CpuInstruction("NOP", _executor.NoOperation, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 7, true));
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 4, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5, true));
      _instructions.Add(new CpuInstruction("INX", _executor.IncrementX, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("SBC", _executor.SubtractWithCarry, _addressingModes.Immediate, 2));
      _instructions.Add(new CpuInstruction("NOP", _executor.NoOperation, _addressingModes.Implicit, 2, true));
      _instructions.Add(new CpuInstruction("???", _executor.SubtractWithCarry, _addressingModes.Implicit, 2, true));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 6, true));
      _instructions.Add(new CpuInstruction("SED", _executor.SetDecimal, _addressingModes.Implicit, 2, true));
