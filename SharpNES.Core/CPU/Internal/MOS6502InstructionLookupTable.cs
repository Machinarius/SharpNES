...
namespace SharpNES.Core.CPU.Internal {
  public class MOS6502InstructionLookupTable : IInstructionLookupTable {
    ...
    private void FillInstructionsList() {
      ...
      _instructions.Add(new CpuInstruction("ORA", _executor.OrWithAccumulator, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("ASL", _executor.ArithmeticShiftLeft, _addressingModes.ZeroPage, 5));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 2));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 8));
      _instructions.Add(new CpuInstruction("BIT", _executor.BitTest, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("AND", _executor.AndWithAccumulator, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("ROL", _executor.RotateLeft, _addressingModes.ZeroPage, 5));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 8));
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 3));
      _instructions.Add(new CpuInstruction("EOR", _executor.ExclusiveOr, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("LSR", _executor.LogicalShiftRight, _addressingModes.ZeroPage, 5));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 8));
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 3));
      _instructions.Add(new CpuInstruction("ADC", _executor.AddWithCarry, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("ROR", _executor.RotateRight, _addressingModes.ZeroPage, 5));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 2));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 6));
      _instructions.Add(new CpuInstruction("STY", _executor.StoreY, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("STA", _executor.StoreAccumulator, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("STX", _executor.StoreX, _addressingModes.ZeroPage, 3));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 6));
      _instructions.Add(new CpuInstruction("LDY", _executor.LoadY, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("LDA", _executor.LoadAccumulator, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("LDX", _executor.LoadX, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 3));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 2));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 8));
      _instructions.Add(new CpuInstruction("CPY", _executor.CompareWithY, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("CMP", _executor.CompareWithAccumulator, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("DEC", _executor.Decrement, _addressingModes.ZeroPage, 5));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5));
      ...
      _instructions.Add(new CpuInstruction("???", _executor.NoOperation, _addressingModes.Implicit, 2));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 8));
      _instructions.Add(new CpuInstruction("CPX", _executor.CompareWithX, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("SBC", _executor.SubtractWithCarry, _addressingModes.ZeroPage, 3));
      _instructions.Add(new CpuInstruction("INC", _executor.Increment, _addressingModes.ZeroPage, 5));
      _instructions.Add(new CpuInstruction("???", _executor.IllegalOpCode, _addressingModes.Implicit, 5));
